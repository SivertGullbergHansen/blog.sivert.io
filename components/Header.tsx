...
export function Header({headerPadding}: {headerPadding: number}) {
  ...
  return (
    <motion.header style={{transition: 'all ease .25s'}} className={`bg-base-100 z-50 flex flex-row p-${headerPadding} place-items-center justify-between fixed top-0 left-0 right-0`}>
